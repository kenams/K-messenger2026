...
- Android packaging follows upstream libsignal guidance, strips non-Android desktop JNI resources and verifies the real Android JNI runtime inside the assembled release APK.
