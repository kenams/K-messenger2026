...
describe('K-ssenger V2 Beta release metadata', () => {
  it('uses stable store identifiers and V2 beta semantic versioning', () => {
    expect(appConfig.expo?.name).toBe('K-ssenger');
    expect(appConfig.expo?.version).toBe('2.0.0-beta.1');
