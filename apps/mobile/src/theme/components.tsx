...
function createStyles(palette: Palette, typo: TypeTokens) {
  ...
  headerBack: { width: 36, height: 36, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center', marginLeft: -spacing.xs, backgroundColor: 'rgba(255,255,255,0.08)' },
