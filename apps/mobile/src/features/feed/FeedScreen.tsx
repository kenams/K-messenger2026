...
const styles = StyleSheet.create({
  ...
  muted: { color: '#7fa0b1' },
  toolbar: { minHeight: 52, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: ink },
  toolbarBrand: { color: palette.azure, fontSize: 10, letterSpacing: 2.4, fontWeight: '900' },
  toolbarTitle: { color: palette.white, fontWeight: '900', fontSize: 19, marginTop: 1 },
  createButton: { backgroundColor: palette.azure, borderRadius: radius.md, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  createText: { color: palette.white, fontWeight: '900' },
  ...
  empty: { flex: 1, minHeight: ITEM_HEIGHT, alignItems: 'center', justifyContent: 'center', padding: spacing.xxl, backgroundColor: palette.sky, gap: spacing.xs },
  emptyIcon: { fontSize: 32 },
  emptyTitle: { fontSize: 20, fontWeight: '900', color: palette.ink },
  emptyText: { marginTop: spacing.xs, textAlign: 'center', color: palette.inkSoft, lineHeight: 20, maxWidth: 300 },
});
