...
export function FeedScreen({ userAge = 18 }: { userAge?: number }) {
  ...
  if (loading) return <View style={styles.loading}><ActivityIndicator color={colors.azure} /><Text style={styles.muted}>Chargement du K-Feed…</Text></View>;
  return (
...
function createStyles(palette: Palette, typo: TypeTokens) {
  ...
  container: { flex: 1, backgroundColor: immersive.surface },
  loading: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, backgroundColor: immersive.surface },
  muted: { color: immersive.mutedText },
  toolbar: { minHeight: 56, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: immersive.surface, borderBottomWidth: 1, borderBottomColor: immersive.border },
  ...
  noticeBox: { paddingHorizontal: spacing.md, paddingVertical: spacing.sm, backgroundColor: immersive.noticeBg },
  notice: { color: immersive.noticeText, textAlign: 'center', fontSize: 11, fontWeight: '700' },
  card: { height: ITEM_HEIGHT, backgroundColor: immersive.surface, position: 'relative' },
  videoSurface: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: immersive.panel },
  nativeVideo: { width: '100%', height: '100%', backgroundColor: immersive.videoBlack },
  ...
  mediaHint: { color: immersive.hintText, marginTop: spacing.sm, fontSize: 11, textAlign: 'center', maxWidth: 320 },
  overlay: { position: 'absolute', left: 0, right: 0, bottom: 0, padding: spacing.lg, flexDirection: 'row', alignItems: 'flex-end', backgroundColor: immersive.scrim },
  ...
  rating: { color: immersive.ratingText, marginTop: spacing.sm, fontSize: 11 },
  ...
  warning: { margin: spacing.xl, padding: spacing.xl, borderRadius: radius.xl, backgroundColor: immersive.scrimStrong, alignItems: 'center', maxWidth: 420 },
  warningIcon: { fontSize: 42 },
  warningTitle: { color: palette.white, fontSize: 22, fontWeight: '900', marginTop: spacing.sm },
  warningText: { color: immersive.warningText, textAlign: 'center', marginTop: spacing.sm, lineHeight: 20 },
  ...
  revealText: { color: immersive.panel, fontWeight: '900' },
  empty: { flex: 1, minHeight: ITEM_HEIGHT, alignItems: 'center', justifyContent: 'center', padding: spacing.xxl, backgroundColor: immersive.surface, gap: spacing.xs },
  emptyIcon: { fontSize: 34 },
  emptyTitle: { fontSize: 20, fontWeight: '900', color: palette.white },
  emptyText: { marginTop: spacing.xs, textAlign: 'center', color: immersive.emptyText, lineHeight: 20, maxWidth: 300 },
  });
}
