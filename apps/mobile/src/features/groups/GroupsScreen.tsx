...
export function GroupsScreen() {
  ...
  return (
    ...
    <ScrollView style={styles.page} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.security}><Text style={styles.securityTitle}>🔒 Sécurité</Text><Text style={styles.muted}>Rôles et modération sont vérifiés côté serveur. Chiffrement de bout en bout actif dans chaque salon dès que sa clé est initialisée — voir le détail du chiffrement en ouvrant une discussion.</Text></View>
    </ScrollView>
    </KeyboardAvoidingView>
  );
}
