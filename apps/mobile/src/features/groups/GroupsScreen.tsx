...
export function GroupsScreen() {
  ...
  return (
    ...
    <ScrollView style={styles.page} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.security}><Text style={styles.securityTitle}>🔒 Sécurité</Text><Text style={styles.muted}>Rôles et modération sont vérifiés côté serveur. Messages chiffrés de bout en bout : même K-ssenger ne peut pas les lire.</Text></View>
    </ScrollView>
    </KeyboardAvoidingView>
  );
}
