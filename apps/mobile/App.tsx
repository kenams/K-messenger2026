...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#d9e7ef', paddingTop: 8, paddingBottom: 10 }, tab: { flex: 1, alignItems: 'center' }, tabIcon: { fontSize: 19 }, tabLabel: { fontSize: 9, color: '#8197a4', marginTop: 2 }, tabActive: { color: '#2788c4', fontWeight: '800' },
